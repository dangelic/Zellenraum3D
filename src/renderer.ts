...
const cameraDistance = worldSize * cellSize * 1.22; // 0.5 ---- offset replace me
...
const animate = () => {
    ...
    world3D.cellMeshContainer.rotation.y += 0.008; // Rotate counter-clockwise
    world3D.frameBoxContainer.rotation.y += 0.008; // Rotate counter-clockwise
